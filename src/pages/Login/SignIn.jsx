...
import { Avatar, Button, TextField, Grid, Typography, InputAdornment, IconButton, CircularProgress, Backdrop, Box, Stack } from "@mui/material"
                  ...
                  InputProps={{
                    endAdornment: (
                      <InputAdornment position="end">
                        <IconButton aria-label="toggle password visibility" onMouseDown={handleMouseDownPassword} onMouseUp={handleMouseDownPassword}>
