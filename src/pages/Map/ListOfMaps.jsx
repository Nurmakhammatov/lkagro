...
const ListOfMaps = ({ open }) => {
  ...
  return (
    <>
      ...
      {/* <div className={`${open ? "left-sidebar-animation-open" : "left-sidebar-animation-close"}`}> */}
      {/* <Grow in={open} appear={true} className={`${open ? "left-sidebar-animation-open" : "left-sidebar-animation-close"}`} {...(open ? { timeout: 1500 } : {})}> */}
      <Box
        className={`${open ? "left-sidebar-animation-open" : "left-sidebar-animation-close"}`}
        sx={{
          position: "absolute",
          // width: sidebar ? "15%" : "5%",
          height: "100vh",
